...
class Onum_PortfolioFilter extends Widget_Base{
	...
	protected function _register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .projects-box .portfolio-info:not(.s2) .portfolio-info-inner, {{WRAPPER}} .projects-box .s2',
			]			
		);
		$this->add_group_control(
	...
	protected function render() {
		...
		<div class="project-filter-wrapper">
	        ...
	        <div class="projects-grid <?php if( $settings['layout'] == 'style2' ){ echo 'projects-style-2 '; } if( $settings['column'] == '5' ){ echo 'pf_5_cols'; }elseif( $settings['column'] == '4' ){ echo 'pf_4_cols'; }elseif( $settings['column'] == '2' ){ echo 'pf_2_cols'; }else{ echo ''; } ?>">
									...
									<?php
										if ( has_post_thumbnail() ) {
											if( $settings['layout'] == 'style2' ){
												the_post_thumbnail( 'onum-portfolio-thumbnail-masonry' );
											}else {
												the_post_thumbnail( 'onum-portfolio-thumbnail-left-top' );
											}			
										}
									?>
								</a>
...
Plugin::instance()->widgets_manager->register_widget_type( new Onum_PortfolioFilter() );