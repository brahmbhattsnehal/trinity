            ...
            <main id="main" class="site-main">
                <div class="single-portfolio-navigation">
                    <?php 
                        ...
                        previous_post_link( '%link', '<span class="flaticon-arrow-pointing-to-left"></span>'.esc_html__( 'Previous', 'engitech' ) );
                        echo '</div><div class="post-next">';
                        next_post_link( '%link', esc_html__( 'Next', 'engitech' ).'<span class="flaticon-arrow-pointing-to-right"></span>' );
                        echo '</div></div>';
                    ?>
                </div>
