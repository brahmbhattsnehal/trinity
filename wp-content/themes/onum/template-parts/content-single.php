...
<article id="post-<?php the_ID(); ?>" <?php post_class('post-box blog-post'); ?>>
    <div class="single-post-inner">
        <?php if( $format == 'gallery' ) { ?>
            <div class="entry-media">
                ...
                <?php if( function_exists( 'rwmb_meta' ) ) { ?>
                    <?php $images = rwmb_meta( 'post_gallery', array( 'size' => 'onum-blog-list-post-thumbnail' ) ); ?>
                    <?php if($images){ ?>              
        ...
        <?php }elseif( $format == 'image' ) { ?>
            ...
            <div class="entry-media">
                <?php if( function_exists( 'rwmb_meta' ) ) { ?>
                    <?php $images = rwmb_meta( 'post_image', array( 'size' => 'onum-blog-list-post-thumbnail' ) ); ?>
                    <?php if($images){ ?>              
                        <?php foreach ( $images as $image ) {  ?> 
                            <img src="<?php echo esc_url( $image['url'] ); ?>" alt="<?php echo esc_attr( $image['alt'] ); ?>" width="<?php echo esc_attr( $image['width'] ); ?>" height="<?php echo esc_attr( $image['height'] ); ?>">
        ...
        <?php }elseif ( has_post_thumbnail() ) { ?>
            ...
            <div class="entry-media">
                <?php the_post_thumbnail( 'onum-blog-list-post-thumbnail' ); ?>
            </div>
